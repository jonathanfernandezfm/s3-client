...
```typescript
// Connections
['connections'][('connections', connectionId)][ // All connections // Single connection
	// Buckets
	('buckets', connectionId)
][ // All buckets for connection
	// Objects
	('objects', connectionId, bucket, path)
][('object', connectionId, bucket, key)]; // Objects in path // Single object metadata
```
